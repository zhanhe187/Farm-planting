...
('A1 号温室', 8.50, '壤土', 3, 42, 35, 180, 108, 'GROWING'),
('B2 露天地', 15.20, '沙壤土', 3, 255, 55, 245, 126, 'READY_HARVEST'),
('C3 试验田', 6.80, '黑土', 2, 95, 190, 160, 110, 'PLANNED'),
('D4 果蔬区', 12.00, '黏壤土', 2, 295, 220, 205, 130, 'GROWING');

insert into farm_crop(name, variety, min_growth_days, image_url) values
('番茄', '粉果 618', 80, 'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?auto=format&fit=crop&w=900&q=80'),
('黄瓜', '津优 35', 55, 'https://images.unsplash.com/photo-1449300079323-02e209d9d3a6?auto=format&fit=crop&w=900&q=80'),
('草莓', '红颜', 95, 'https://images.unsplash.com/photo-1464965911861-746a04b4bca6?auto=format&fit=crop&w=900&q=80');

insert into farm_material(name, category, unit, safe_interval_days) values
('番茄种子', 'SEED', '袋', 0),
('有机复合肥', 'FERTILIZER', 'kg', 0),
('吡虫啉水分散粒剂', 'PESTICIDE', 'g', 7),
('代森锰锌可湿性粉剂', 'PESTICIDE', 'g', 10);
...
(1, 'PLANNED', 'SOWED', '农技员小林', '完成播种'),
(1, 'SOWED', 'GROWING', '农技员小林', '出苗稳定'),
(2, 'GROWING', 'READY_HARVEST', '农技员小林', '达到采收标准');

insert into plant_operation(batch_id, type, operation_date, worker_name, note) values
(1, 'SOWING', '2026-03-01', '田间工人阿强', '穴盘育苗后移栽'),
(1, 'FERTILIZE', '2026-04-16', '田间工人阿强', '追施有机复合肥，长势良好'),
(1, 'PESTICIDE', '2026-05-10', '田间工人阿强', '发现蚜虫点片发生，局部防治'),
(2, 'SOWING', '2026-03-20', '田间工人阿强', '黄瓜直播'),
(2, 'PESTICIDE', '2026-05-01', '田间工人阿强', '霜霉病预防性处理');
...
('本地-Chat', 'LOCAL_FALLBACK', 'http://localhost:8080/mock-ai', 'local-****-key', 'fpms-local-advisor', 'CHAT', 10, 1),
('本地-Vision', 'LOCAL_FALLBACK', 'http://localhost:8080/mock-vision', 'local-****-key', 'fpms-local-vision', 'VISION', 10, 1);
